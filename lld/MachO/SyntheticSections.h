...
//
// The compiler stores initializers as pointers in __mod_init_func. These need
...
// deprecated, and static destructors are handled by registering them via
// __cxa_atexit from an autogenerated initializer function (see D121736).
